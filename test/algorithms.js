...
const ecc = artifacts.require("./algorithms/ECCAlgorithm.sol");
...
contract('ECCAlgorithm', function (accounts) {
  ...
  it.only('should return true for valid signatures', async function() {
    ...
    // let foo =  await instance.verify(vector[0], vector[1], vector[2])
